...
export default function About() {
  return (
    <Box className={styles.container}>
      <Container className={styles.container_news}>
        <h1>JEAN BARBER</h1>
        <figure className={styles.container_figure}>
          <img className={styles.photo} src={photo} alt="logo homem de barba" />
          <article>
            ...
            novos clientes a cada dia. Nossa missão é: "Proporcionar auto-estima
            e qualidade de vida aos clientes". O atendimento possui padrão de
